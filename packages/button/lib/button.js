...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        ...
        var cls = classnames_1.default('mdc-button', {
        ...
        return (react_1.default.createElement("button", __assign({ className: cls }, otherProps),
            react_1.default.createElement("span", { className: "mdc-button__label" }, children)));
    };
    Button.defaultProps = {
